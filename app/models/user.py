...
class User(Base):
    ...
    allowed_schedule_start = Column(Time(timezone=False), nullable=True, default=None)
    allowed_schedule_end = Column(Time(timezone=False), nullable=True, default=None)
